...
namespace CodigoDeitel.Logic {
    public class EmpleadoBaseMasComision2 : EmpleadoPorComision {
        ...
        public EmpleadoBaseMasComision2(string nombre, string apellido, string nss, decimal ventas, decimal tarifa, decimal salario) : base(nombre, apellido, nss, ventas, tarifa) {
            salarioBase = salario; // valida el salario base a través de una propiedad
        } // fin del constructor de EmpleadoBaseMasComision2 con seis parámetros
