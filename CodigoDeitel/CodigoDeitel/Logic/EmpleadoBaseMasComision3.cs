...
namespace CodigoDeitel.Logic {
    public class EmpleadoBaseMasComision3: EmpleadoPorComision2 {
        ...
        public EmpleadoBaseMasComision3( string nombre, string apellido, string nss, decimal ventas, decimal tarifa, decimal salario ) : base( nombre, apellido, nss, ventas, tarifa ){
